...
flags.DEFINE_integer("num_steps", 1000, "Number of steps [20000]")
...
flags.DEFINE_integer("save_period", 30, "Save Period [1000]")
...
flags.DEFINE_integer("ques_size_th", 62, "ques size th [32]")
flags.DEFINE_integer("word_size_th", 35, "word size th [16]")
